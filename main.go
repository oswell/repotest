...
func headDigest(client *http.Client, manifestURL, repository, tag string) (string, bool) {
	...
	spew.Dump(manifestRequest)
	fatalIf("failed to fetch manifest", err)
	spew.Dump(manifestResponse)
